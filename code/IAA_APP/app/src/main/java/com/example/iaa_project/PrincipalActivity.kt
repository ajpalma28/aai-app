        ...
        if(notifUsuDef){
            try {
                ...
                Handler(Looper.getMainLooper()).post {
                    ...
                    lanzaNotificacion(true, "Notificaciones activadas", "Se han activado las notificaciones de la aplicación para el investigador $nombUsuDef $apellUsuDef (id: $idUsuDef)")
                    swNotif!!.text="Notificaciones ACTIVADAS"
                    swNotif!!.setTextColor(Color.BLACK)
                ...
                Handler(Looper.getMainLooper()).post {
                    ...
                    txtMostrar.show()
                    swNotif!!.isChecked=true
                    lanzaNotificacion(false,"Error en el cambio de las notificaciones", "No se han podido activar las notificaciones de la aplicación para el investigador $nombUsuDef $apellUsuDef (id: $idUsuDef). Inténtelo de nuevo más tarde.")
                }
            }
            ...
            try {
                ...
                Handler(Looper.getMainLooper()).post {
                    ...
                    txtMostrar.setGravity(Gravity.CENTER_VERTICAL, 0, 0)
                    txtMostrar.show()
                    lanzaNotificacion(false,"Notificaciones desactivadas", "Se han desactivado las notificaciones de la aplicación para el investigador $nombUsuDef $apellUsuDef (id: $idUsuDef)")
                    this@PrincipalActivity.notifUsuDef = notifUsuDef
                    swNotif!!.text="Notificaciones DESACTIVADAS"
                    swNotif!!.setTextColor(Color.RED)
                ...
                Handler(Looper.getMainLooper()).post {
                    ...
                    txtMostrar.setGravity(Gravity.CENTER_VERTICAL, 0, 0)
                    txtMostrar.show()
                    lanzaNotificacion(false,"Error en el cambio de las notificaciones", "No se han podido desactivar las notificaciones de la aplicación para el investigador $nombUsuDef $apellUsuDef (id: $idUsuDef). Inténtelo de nuevo más tarde.")
                    swNotif!!.isChecked=false
                }
            }
        }
